...
if(isset($_POST['submit'])) 
{
    ...
    $qry=mysqli_query($conn,"SELECT * FROM login WHERE login_username='$email' AND login_password='$password'");
    $num=mysqli_fetch_array($qry);
if($num>0)
{
$extra="services.php";//
$_SESSION['login']=$_POST['email'];
$_SESSION['id']=$num['login_user_id'];
$_SESSION['username']=$num['user_firstname'].$num['user_lastname'];
