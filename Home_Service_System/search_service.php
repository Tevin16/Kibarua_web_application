                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="candidates_single.html"><?php echo $row['freelancer_firstname'].' '.$row['freelancer_lastname'] ?></a></h4>
                                    <h5 class="mt-2"><span><?php echo $row['catname'] ; ?></span> ( <?php echo $row['subcatname'] ; ?> )</h5>
                                    <p><i class="fas fa-map-marker-alt"></i> <?php echo $row['freelancer_location'] ; ?></p>
                                    <ul class="links_bottom_emp mt-2">
                                        <li><a href="candidates_single.html"><i class="far fa-envelope"></i> <span class="icon_text"> <?php echo $row['freelancer_email'] ; ?></span></a></li>
                                        <li><a href="#"><i class="fas fa-eye"></i> <span class="icon_text"> <?php echo $row['freelancer_experience'] ?></span>Year</a></li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="col-md-3 emp_btn text-right">
                               <a href="book_now.php?pid=<?php echo htmlentities($row['freelancer_id']);?>" class="aply-btn ">Book Now</a>
                            </div>
                        </div>
                        <!--// Emply List -->
                       <?php } ?>
