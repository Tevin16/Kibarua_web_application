...
$query=mysqli_query($conn,"update booking set booking_service_rating='$service_rating',booking_price_rating='$service_price',booking_values_rating='$service_value',booking_review='$review' where booking_id='$rid'");
