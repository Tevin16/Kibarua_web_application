...
{
$status=$_POST['booking_bookstatus'];



$sql=mysqli_query($conn,"update booking set booking_bookstatus='$status' where booking_id='$bid'");
if($sql)
{
                ...
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-10 job_info">
                        ...
                        <div class="emply-resume-list row mb-3">
                            ...
                            $query=mysqli_query($conn,"select booking.*,users.user_firstname as cname,users.user_lastname as lname,users.user_email as cemail,users.user_mobile as contact,users.user_address as caddress from booking inner join users on booking.booking_user_id=users.user_id  where booking.booking_id='$bid'");
                            ...
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control jb_1" name="booking_bookstatus">


                                            <option value="<?php echo ($row['booking_bookstatus']);?>" readonly>
