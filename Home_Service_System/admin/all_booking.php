...
$query=mysqli_query($conn,"select booking.*,users.user_firstname as cname,users.user_lastname as lname,users.user_email as cemail,users.user_mobile as contact,users.user_address as caddress,freelancer.freelancer_firstname as providername,freelancer.freelancer_lastname as providerlname,freelancer.freelancer_email as provideremail,freelancer.freelancer_mobile as providercontact,freelancer.freelancer_address as provideraddress,category.category_categoryName as providercat,subcategory.subcategory_name as providersubcat,freelancer.freelancer_image as providerimg from booking inner join users on booking.booking_user_id=users.user_id inner join freelancer on booking.booking_freelancer_id=freelancer.freelancer_id inner join category on booking.booking_category_id=category.category_id inner join subcategory on booking.booking_subcategory_id=subcategory.subcategory_id");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
         ?>
                ...
                <tr>
                  ...
                  <td><?php if($row['booking_bookstatus'] == 1) { ?>
