...
$admin=mysqli_query($conn,"SELECT * FROM login WHERE login_username='$username' and login_password='$password'");
$num=mysqli_fetch_array($admin);
if($num>0)
{
$loc="dashboard.php";//
$_SESSION['admin_login']=$_POST['username'];
$_SESSION['id']=$num['login_admin_id'];
$_SESSION['username']=$num['login_username'];
