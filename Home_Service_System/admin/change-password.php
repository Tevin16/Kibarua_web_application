...
{
$sql=mysqli_query($conn,"SELECT login_password FROM  login where login_password='".md5($_POST['password'])."' && login_username='".$_SESSION['admin_login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn,"update login set login_password='".md5($_POST['newpassword'])."' where login_username='".$_SESSION['admin_login']."'");
