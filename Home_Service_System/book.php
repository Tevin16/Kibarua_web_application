...
header('location:login.php');
  ...
  $sid=$_GET['sid'];
  $cid=$_POST['category_categoryName'];
  $subcid=$_POST['subcategory_name'];
  $service_date=$_POST['s_date'];
  $service_time=$_POST['ser_time'];
  $remark=$_POST['remark'];

$query=mysqli_query($conn,"insert into booking(booking_user_id,booking_freelancer_id,booking_category_id,booking_subcategory_id,booking_service_date,booking_service_time,booking_remark) values('".$_SESSION['id']."','$sid','$cid','$subcid','$service_date','$service_time','$remark')");
         ...
         ?>
                 <div class="form-group">
                               <!-- <label>Service Name</label> -->
                                ...
                                <input type="hidden" class="form-control" name="category_categoryName" value="<?php echo $row['freelancer_category_id'];?>"<?php echo $row['category_categoryName'];?>>
                            </div>
                            <div class="form-group">
                             <!--   <label>Service Details</label> -->

                                <input type="hidden" class="form-control" name="subcategory_name" value="<?php echo $row['freelancer_subcategory_id'];?>"<?php echo $row['subcategory_name'];?>>
                            </div>
                          <?php } ?>
