                                            ...
                                            <div class="col-lg-10 job-post-info text-left">
                                                ...
                                                <div class="job-single-sec">
                                                    ...
                                                    <ul class="job-list-info d-flex">
                                                        <li>
                                                            <i class="fas fa-briefcase"></i><?php echo $row['freelancer_location']; ?></li>
                                                        <li>
                                                            <i class="fas fa-map-marker-alt"></i> <?php echo $row['freelancer_address']; ?></li>
                                                        <li>
                                                           ksh <?php echo $row['freelancer_rate']; ?>  / Service</li>
                                                    </ul>
