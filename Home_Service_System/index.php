                                        ...
                                        <div class="job-post-main row">
                                            <div class="col-md-9 job-post-info text-left">
                                                ...
                                                <div class="job-single-sec">
                                                    ...
                                                    <h4>
                                                        <a href="#"><?php echo $row['category_categoryName']; ?></a>
                                                    </h4>
                                                    <p class="my-2"><?php echo $row['subcategory_name']; ?></p>
...
$query=mysqli_query($conn,"select booking.*,freelancer.freelancer_address as provideraddress,freelancer.freelancer_location as providerloc,freelancer.freelancer_rate as rate,category.category_categoryName as providercat,subcategory.subcategory_name as providersubcat from booking inner join service on booking.serviceid=service.id inner join category on booking.booking_category_id=category.category_id inner join subcategory on booking.booking_subcategory_id=subcategory.subcategory_id where booking.booking_service_rating = 5");
